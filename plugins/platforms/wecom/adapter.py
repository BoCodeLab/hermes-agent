...
class WeComAdapter(BasePlatformAdapter):
    ...
    async def send(
        ...
        if metadata:
            ...
            # hermes-work customization: the work user gate signals the same
            # intent under a different key — treat it as an alias.
            force_proactive = force_proactive or bool(
                metadata.pop("wecom_force_proactive", False)
            )
